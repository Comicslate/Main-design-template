...
<html xml:lang = "' . $conf [ "lang" ] . '" lang = "' . $conf [ "lang" ] . '" dir = "' . $lang [ "direction" ] . '">
	<head>
		...
		<link rel = "alternate" type = "application/json+oembed" href = "https://app.comicslate.org/embed.json?id=' . $ID . ( $REV == false ? '' : '&amp;rev='. $REV ) . '" />
...
echo '
			<noindex>
				<aside id = "pagetools">
					<ul>' . ( new \dokuwiki\Menu\PageMenu ( ) ) -> getListItems ( ) . '
					</ul>
				</aside>
			</noindex>';
