// Г А Л О Ч К И   О П Ц И Й   ver. 2020.08.17 18:19 GMT+10
// console.log ( 5 );
...
/* ВВОДНЫЕ */
	...
	if ( window.location.href.match ( /[\?&]do=/i ) == null ) { // только на готовых страницах
		...
		var folder_cookie3 = 'scrShot_' + JSINFO.namespace, // фотографирование комиксов
			...
			shot_style_on = '.fn-area, .ct-area, .reveal_check, .color_check, .ct-container > img.media, .fn-container > img.media { display: none !important } .img-repl { display: inherit !important }', // стиль на фото
