...
/* ВВОДНЫЕ */
	...
	if ( window.location.href.match ( /[\?&]do=/i ) == null ) { // только на готовых страницах
		...
		var folder_cookie3 = 'scrShot_' + JSINFO.namespace, // фотографирование комиксов
			...
			shot_style_on = '.fn-note, .ct-note, .ct-container > img.media, .fn-container > img.media { display: none !important; } .img-repl { display: inherit !important; }', // стиль на фото
